...
export default class Map extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      sites :[
        {id:1,wasOnsite :0, latitude: 30.8219382, longitude: 34.7430979, image : require('../assets/Map/1.png'), imageBig : require('../assets/2.jpg')}, 
  ...
  Alertt = (siteId) =>{
    ...
    Alert.alert(
      ...
      [
        ...
        {text: 'OK', onPress: () => this.props.navigation.navigate('Story')},
      ],
      {cancelable: false},
    );
  }
  isOnSite = (newCoordinate) => {
      ...
      console.log ('tal lot ' + newCoordinate.latitude +"tal long "+ newCoordinate.longitude )
